...
#'
#' Otherwise, the function will for convenience generate try to generate a rowwise to_unit specification by either expanding a crosswalk table (if both from_unit and to_unit are present) or testing x$unit for convertibility to to_unit.
